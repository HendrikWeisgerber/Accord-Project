      ...
      case 'List':
        {
          ...
          thing.nodes.forEach(item => {
            ...
            if (thing.type === 'ordered') {
              parameters.result += "".concat(ToMarkdownStringVisitor.mkPrefix(parameters, level)).concat(this.options.noIndex ? 1 : index, ". ").concat(ToMarkdownStringVisitor.visitChildren(this, item, parameters, ToMarkdownStringVisitor.mkParametersInList));
            } else {
              parameters.result += "".concat(ToMarkdownStringVisitor.mkPrefix(parameters, level), "-  ").concat(ToMarkdownStringVisitor.visitChildren(this, item, parameters, ToMarkdownStringVisitor.mkParametersInList));
            }
