...
class Stack {
  ...
  */
  ...
  push(obj) {
    let appendItem = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : true;
  ...
  */
  ...
  append(obj) {
    ...
    if (top && top.nodes) {
      ...
      throw new Error("Cannot append. Invalid stack: ".concat(JSON.stringify(this.stack, null, 4)));
    }
  }
  /**
