...
describe('markdown', () => {
  getMarkdownFiles().forEach((_ref) => {
    ...
    it("converts ".concat(file, " to concerto JSON"), () => {
...
describe('to plain text', () => {
  getMarkdownFiles().forEach((_ref2) => {
...
describe('readme', () => {
  it('converts example1 to CommonMark DOM', () => {
    ...
    const newMarkdown = commonMark.toMarkdown(json); // console.log(newMarkdown);
...
describe('acceptance', () => {
  it('converts acceptance to CommonMark DOM', () => {
    ...
    const json = commonMark.fromMarkdown(markdownText, 'json'); // console.log(JSON.stringify(json, null, 4));
...
describe('markdown-spec', () => {
  getMarkdownSpecFiles().forEach((_ref3) => {
    let [file, markdownText] = _ref3;
    it("converts ".concat(file, " to concerto JSON"), () => {
      const json = commonMark.fromMarkdown(markdownText, 'json');
      expect(json).toMatchSnapshot();
