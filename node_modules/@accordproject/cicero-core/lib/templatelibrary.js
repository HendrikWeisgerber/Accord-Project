...
class TemplateLibrary {
  ...
  getTemplateIndex(options) {
    ...
    return _asyncToGenerator(function* () {
      ...
      const httpOptions = {
        uri: "".concat(_this.url, "/template-library.json"),
        headers: {
          'User-Agent': 'clause'
        },
      ...
      return rp(httpOptions).then(templateIndex => {
  ...
  getTemplate(templateUri) {
    ...
    return _asyncToGenerator(function* () {
      ...
      const template = yield Template.fromUrl(templateMetadata.url); // check the hash matches
