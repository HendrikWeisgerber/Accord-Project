...
class TemplateLoader extends FileLoader {
  ...
  static fromArchive(Template, buffer, options) {
    return _asyncToGenerator(function* () {
      ...
      const templatizedGrammar = yield TemplateLoader.loadZipFileContents(zip, 'text/grammar.tem.md', false, false);
  ...
  static fromDirectory(Template, path, options) {
    return _asyncToGenerator(function* () {
      ...
      let templatizedGrammar = yield TemplateLoader.loadFileContents(path, 'text/grammar.tem.md', false, false);
